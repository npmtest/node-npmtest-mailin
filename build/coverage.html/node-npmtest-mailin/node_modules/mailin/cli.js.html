...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mailin/node_modules/mailin/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mailin/node_modules/mailin/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mailin/node_modules/mailin/</a> &#187; cli.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function collectOptions(keyValue, options) {</span>
<span class="cstat-no" title="statement not covered" >    if (!keyValue || keyValue.indexOf(':') &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        logger.error('Ignoring option '  + keyValue);</span>
...
<span class="cstat-no" title="statement not covered" >    var split = keyValue.split(':');</span>
<span class="cstat-no" title="statement not covered" >    options[split[0]] = split[1];</span>
<span class="cstat-no" title="statement not covered" >    return options;</span>
}
&nbsp;
...
mailin.start({
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) <span class="cstat-no" title="statement not covered" >process.exit(1);</span>
&nbsp;
    logger.info('Webhook url: ' + mailin.configuration.webhook);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (mailin.configuration.logFile) logger.info('Log file: ' + mailin.configuration.logFile);
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (mailin.configuration.disableDkim) <span class="cstat-no" title="statement not covered" >logger.info('Dkim checking is disabled');</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (mailin.configuration.disableSpf) <span class="cstat-no" title="statement not covered" >logger.info('Spf checking is disabled');</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (mailin.configuration.disableSpamScore) <span class="cstat-no" title="statement not covered" >logger.info('Spam score computation is disabled');</span>
});
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
